...
highlight @attribute guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight @constant guifg=#88C0D0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @constant.builtin guifg=#D08F70 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @constant.macro guifg=#D57780 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @constructor guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @danger guifg=#BF616A guibg=NONE guisp= gui=bold cterm=bold term=bold
highlight @error guifg=#BF616A guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @exception guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @field guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight @function.builtin guifg=#88C0D0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @function.macro guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight @keyword.function guifg=#B988B0 guibg=NONE guisp= gui=italic cterm=italic term=italic
highlight @keyword.operator guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @keyword.return guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @label guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @method guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @namespace guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight @punctuation.special guifg=#5E81AC guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight @string.escape guifg=#D08F70 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @string.regex guifg=#D08F70 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @symbol guifg=#88C0D0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @tag guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @tag.attribute guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @tag.delimiter guifg=#5E81AC guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text guifg=#C8D0E0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text.emphasis guifg=#EBCB8B guibg=NONE guisp= gui=italic cterm=italic term=italic
highlight @text.environment guifg=#C8D0E0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text.environment.name guifg=#C8D0E0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text.literal guifg=#A3BE8C guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text.math guifg=#C8D0E0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text.reference guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @text.strong guifg=#B988B0 guibg=NONE guisp= gui=bold cterm=bold term=bold
highlight @text.title guifg=#81A1C1 guibg=NONE guisp= gui=bold cterm=bold term=bold
highlight @text.underline guifg=NONE guibg=NONE guisp= gui=underline cterm=underline term=underline
highlight @text.uri guifg=#88C0D0 guibg=NONE guisp= gui=underline cterm=underline term=underline
highlight @type guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @type.builtin guifg=#D08F70 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @variable guifg=#C8D0E0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @variable.builtin guifg=#D57780 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight @warning guifg=#D08F70 guibg=NONE guisp= gui=bold cterm=bold term=bold
highlight Boolean guifg=#D08F70 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight NavicIconsArray guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsBoolean guifg=#D08F70 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsClass guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsConstant guifg=#D08F70 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsConstructor guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsEnum guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsEnumMember guifg=#88C0D0 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsEvent guifg=#B988B0 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsField guifg=#81A1C1 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsFile guifg=#81A1C1 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsFunction guifg=#B988B0 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsInterface guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsKey guifg=#B988B0 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsMethod guifg=#B988B0 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsModule guifg=#81A1C1 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsNamespace guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsNull guifg=#D57780 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsNumber guifg=#D08F70 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsObject guifg=#D08F70 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsOperator guifg=#B988B0 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsPackage guifg=#D08F70 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsProperty guifg=#81A1C1 guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsString guifg=#A3BE8C guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsStruct guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
highlight NavicIconsTypeParameter guifg=#EBCB8B guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
...
highlight NeoTreeGitConflict guifg=#D08F70 guibg=NONE guisp= gui=bold,italic cterm=bold,italic term=bold,italic
...
highlight NeotestAdapterName guifg=#B988B0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestDir guifg=#88C0D0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestFailed guifg=#BF616A guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestFile guifg=#88C0D0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestNamespace guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestPassed guifg=#A3BE8C guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestRunning guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight NeotestSkipped guifg=#88C0D0 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight TreesitterContext guifg=NONE guibg=#353B49 guisp= gui=NONE cterm=NONE term=NONE
...
highlight cssTagName guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight htmlArg guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight htmlEndTag guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
...
highlight htmlSpecialTagName guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight htmlTag guifg=#81A1C1 guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight htmlTagN guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
highlight htmlTagName guifg=#EBCB8B guibg=NONE guisp= gui=NONE cterm=NONE term=NONE
